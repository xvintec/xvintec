...
const Footer = () => {
  ...
  return (
    <div className="fl-container animate-fade-up animate-delay-300">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 mt-5 mb-7 ">
        ...
        <div className="text-center md:text-right text-[#202020] text-[14px] font-light">
          ...
          <div className="mt-2 flex flex-wrap justify-center gap-x-4 gap-y-1 md:justify-end">
            <Link href="/privacy-policy" className="hover:text-[#005CC7]">
              Privacy Policy
            </Link>
            <Link href="/cookie-policy" className="hover:text-[#005CC7]">
              Cookie Policy
            </Link>
            <Link href="/terms-and-conditions" className="hover:text-[#005CC7]">
              Terms &amp; Conditions
            </Link>
          </div>
        </div>
